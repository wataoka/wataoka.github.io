  ...
  <div class="research mt-10 px-10">
    ...
    <div class="bg-white rounded-md mt-1 pl-10 pr-6 py-4 shadow-md">
      <ul class="list-square">
        <li>Koki Wataoka, Tsubasa Takahashi, Ryokan Ri, "Self-Preference Bias in LLM-as-a-Judge", <b class="text-red-500">NeurIPS 2024 Safety Generative AI Workshop</b></li>
        <li>Thien Q Tran, Koki Wataoka, Tsubasa Takahashi, "Initial Response Selection for Prompt Jailbreaking using Model Steering", <b class="text-red-500">ICLR 2024 Secure and Trustworthy Large Language Models Workshop</b></li>
        <li>Keita Saito, Akifumi Wachi, Koki Wataoka, Youhei Akimoto, "Verbosity bias in preference labeling by large language models", <b class="text-red-500">NeurIPS 2023 Instruction Tuning and Instruction Following Workshop</b></li>
