...
**Responsible AIチーム, SB Intuitions / ソフトバンク**

![Profile Image](wataoka2025.jpg)

## 概要

SB Intuitions Responsible AIチーム リーダー / Chief Research Engineer。LLMやVLMにおける安全性評価や訓練、レッドチーミングやガードレールなどの**AIセーフティ**に取り組んでいます。研究分野としては、LLM-as-a-Judgeにおけるバイアス、ジェイルブレイク攻撃、LLMのフィンガープリンティング、機械学習の公平性、プライバシー保護計算などです。
...
- [総務省 AIセキュリティ分科会 構成員](https://www.soumu.go.jp/main_sosiki/kenkyu/cybersecurity_taskforce/02cyber01_04000001_00321.html)
...
## 講演
- 2026年1月20日 - 電気情報通信学会 高機能マルチメディア研究会（IEICE EMM）[［招待講演］大規模基盤モデル開発における安全性対策](https://ken.ieice.org/ken/paper/20260120fcqF/)
- 2026年3月9日 - 言語処理学会第32回年次大会(NLP2026) [チュートリアル１：AI Safety: Bridging Academic Research and Industrial Application](https://anlp.jp/nlp2026/#tutorial)
...
**メール:** [wataoka.koki@gmail.com](mailto:wataoka.koki@gmail.com)

**リンク:** [Google Scholar](https://scholar.google.com/citations?user=J8FuRZgAAAAJ) · [GitHub](https://github.com/wataoka) · [X](https://x.com/)